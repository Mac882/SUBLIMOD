...
const ProductForm = ({ onClose, productToEdit, globalAttributes }: ProductFormProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const data = { nombre: productName.trim(), descripcion: description.trim(), categoriaId: categoryId, categoria: category, imagenUrl: uploadedUrls[0], imagenes: uploadedUrls, atributos, colores: colors, escalasPrecios: priceMatrix, updatedAt: serverTimestamp() };
